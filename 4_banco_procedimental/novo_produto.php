<?php
	...
	else
	{
		...
		//prepara um vetor para receber os dados do produto que esta no banco
		$dados_produto = '';

		while ($linha = mysqli_fetch_row($tabela))
		{
			//busca o vetor com as informacoes do produto e coloca no vetor dados_usuario
			$dados_produto = $linha;
		}
	}
?>
...
<html>
	<head>
		<title>Menu do Sistema - Cadastro de Produtos</title>
		<style>
			table {
				width:100%;
			}
	...
	<body>
		<table>
			<tr style="height:50px">
				<td colspan="2">
					<h1>MENU DO SISTEMA CADASTRO DE PRODUTOS</h1>
				</td>
			</tr>
			<tr style="height:50px">
				<td>
					<img style="height:100px" src="imagens/<?php echo $dados_produto[2] . '.jpg'; ?>"></img> <br>
					Seja bem vindo(a) <?php echo $dados_produto[1]; ?>!
				</td>
				<td>
								...
								<?php
									if ($dados_produto[4]==1)
									{
										echo '
											...
											<a href="lista_produto.php">Listar produtos</a><br>												
										';
									}
									else
									{
									...
									<table>
										...
										<tr>
											<td colspan="2" align="right">
												<button type="reset" name="btnApagar">Apagar Produto</button>
												<button type="submit" name="btnSalvar">Adicionar Produto</button>
											</td>
										</tr>
									</table>
								</form>
