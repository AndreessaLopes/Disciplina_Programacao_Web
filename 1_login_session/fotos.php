...
if (isset($_SESSION['login'])) {
    $mensagem = 'Seja bem vindo(a) ' . $_SESSION['login'] . '! </br> Neste momento voc&ecirc; est&aacute; logado em nosso sistema e na p&aacute;gina Fotos. </br> <a href="logout.php">SAIR</a></br>';
} else {
